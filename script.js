...
const firebaseConfig = {
    ...
    */
    apiKey: "AIzaSyBzgH6Tif4ak9TMgGGVpWiheIDVVdNOtF8",
    authDomain: "mayown-bc0ad.firebaseapp.com",
    projectId: "mayown-bc0ad",
    databaseURL: "https://mayown-bc0ad-default-rtdb.firebaseio.com",
    storageBucket: "mayown-bc0ad.appspot.com",
    messagingSenderId: "702195659795",
    appId: "1:702195659795:web:0fc746d8143b239a80fbe6",
    measurementId: "G-13E9Z6ZL0B",
};
...
function addStore(count, e) {
    firebase.database().ref('timer/timer' + count).set({
        time: e.time
    });
    addDiv();
}
